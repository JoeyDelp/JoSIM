...
class Transient {
  ...
  public:
    Transient() : tstep_(0.25E-12), tstop_(0.0), prstart_(0.0), prstep_(1E-12), prfirwindow_(0.0), startup_(true) {};
    ...
    static void identify_simulation(std::vector<tokens_t>& controls, Transient& tObj, param_map& params);
};
} // namespace JoSIM

#endif // JOSIM_TRANSIENT_HPP
