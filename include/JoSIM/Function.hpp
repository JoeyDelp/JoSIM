...
enum class FunctionType { PWL = 0, PULSE = 1, SINUSOID = 2, CUS = 3, NOISE = 4, PWS = 5, DC = 6, EXP = 7 };
...
class Function {
  ...
  public:
    Function() {};
    void                parse_function(const std::string& str, const Input& iObj, const string_o& subckt);
