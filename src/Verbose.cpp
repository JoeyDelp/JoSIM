...
void Verbose::print_circuit_stats(const Input &iObj, const Matrix &mObj) {
  ...
  std::cout << std::left << std::setw(26) << "Main design lines:" << 
  ...
  if(mObj.components.junctionIndices.size() != 0) {
    std::cout << std::left << std::setw(26) << "JJ count:" << 
      mObj.components.junctionIndices.size() << "\n";
  }
  // Print the total inductor count
  if(mObj.components.inductorIndices.size() != 0) {
    std::cout << std::left << std::setw(26) << "Inductor count:" << 
      mObj.components.inductorIndices.size() << "\n";
  }
  ...
  if(mObj.components.resistorIndices.size() != 0) {
    std::cout << std::left << std::setw(26) << "Resistor count:" << 
      mObj.components.resistorIndices.size() << "\n";
  }
  // Print the total capacitor count
  if(mObj.components.capacitorIndices.size() != 0) {
    std::cout << std::left << std::setw(26) << "Capacitor count:" << 
      mObj.components.capacitorIndices.size() << "\n";
  }
  ...
  if(mObj.components.vsIndices.size() != 0) {
    std::cout << std::left << std::setw(26) << "Voltage source count:" << 
      mObj.components.vsIndices.size() << "\n";
  }
  // Print the total Phase source count
  if(mObj.components.psIndices.size() != 0) {
    std::cout << std::left << std::setw(26) << "Phase source count:" << 
      mObj.components.psIndices.size() << "\n";
  }
  // Print the total TX line count
  if(mObj.components.txIndices.size() != 0) {
    std::cout << std::left << std::setw(26) << "TX line count:" << 
      mObj.components.txIndices.size() << "\n";
  }
  // Print the total CCCS count
  if(mObj.components.cccsIndices.size() != 0) {
    std::cout << std::left << std::setw(26) << "CCCS count:" << 
      mObj.components.cccsIndices.size() << "\n";
  }
  // Print the total CCVS count
  if(mObj.components.ccvsIndices.size() != 0) {
    std::cout << std::left << std::setw(26) << "CCVS count:" << 
      mObj.components.ccvsIndices.size() << "\n";
  }
  // Print the total VCCS count
  if(mObj.components.vccsIndices.size() != 0) {
    std::cout << std::left << std::setw(26) << "VCCS count:" << 
      mObj.components.vccsIndices.size() << "\n";
  }
  // Print the total VCVS count
  if(mObj.components.vcvsIndices.size() != 0) {
    std::cout << std::left << std::setw(26) << "VCVS count:" << 
      mObj.components.vcvsIndices.size() << "\n";
  }
  std::cout << std::endl;
}
