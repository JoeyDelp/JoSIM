...
//           mObj.components.phaseRes.at(j.index).pn1 = -lhsValues.at(mObj.components.phaseRes.at(j.index).negNRow);
//         } else if (mObj.components.phaseRes.at(j.index).negNRow == -1) {
//           mObj.components.phaseRes.at(j.index).pn1 = lhsValues.at(mObj.components.phaseRes.at(j.index).posNRow);
//         } else {
//           mObj.components.phaseRes.at(j.index).pn1 = lhsValues.at(mObj.components.phaseRes.at(j.index).posNRow) - lhsValues.at(mObj.components.phaseRes.at(j.index).negNRow);
//         }
//         mObj.components.phaseRes.at(j.index).IRn1 = lhsValues.at(mObj.components.phaseRes.at(j.index).curNRow);
...
//           * mObj.components.phaseCap.at(j.index).value)) 
//           * mObj.components.phaseCap.at(j.index).ICn1 
//           - mObj.components.phaseCap.at(j.index).pn1 
//           - (iObj.transSim.prstep * mObj.components.phaseCap.at(j.index).dPn1);
//       } else if (j.type == RowDescriptor::Type::PhaseVS) {
//         if (mObj.components.phaseVs.at(j.index).posNRow == -1.0)
//           mObj.components.phaseVs.at(j.index).pn1 = -lhsValues.at(mObj.components.phaseVs.at(j.index).negNRow);
//         else if (mObj.components.phaseVs.at(j.index).negNRow == -1.0)
//           mObj.components.phaseVs.at(j.index).pn1 = lhsValues.at(mObj.components.phaseVs.at(j.index).posNRow);
//         else
//           mObj.components.phaseVs.at(j.index).pn1 = lhsValues.at(mObj.components.phaseVs.at(j.index).posNRow) - lhsValues.at(mObj.components.phaseVs.at(j.index).negNRow);
//         if (i >= 1)
...
//             * mObj.components.txPhase.at(j.index).value) / (PHI_ZERO)) 
//             * results.xVect.at(std::distance(mObj.relXInd.begin(),
//                           std::find(mObj.relXInd.begin(), mObj.relXInd.end(),
//                                     mObj.components.txPhase.at(j.index).curN2Row)))
//                       .at(i - mObj.components.txPhase.at(j.index).k) 
//             + mObj.components.txPhase.at(j.index).p1n1 + (iObj.transSim.prstep / 2) 
//             * (mObj.components.txPhase.at(j.index).dP1n1 + mObj.components.txPhase.at(j.index).dP2nk);
//         }
...
//                       .at(i - mObj.components.txPhase.at(j.index).k) 
//             + mObj.components.txPhase.at(j.index).p2n1 + (iObj.transSim.prstep / 2) 
//             * (mObj.components.txPhase.at(j.index).dP2n1 + mObj.components.txPhase.at(j.index).dP1nk);
//         }
//       }
//       RHS.push_back(RHSvalue);
//       rowCounter++;
...
//           thisJJ.iT = 0.0;
//           if (thisJJ.pPtr != -1) {
//             if (mObj.mElements.at(thisJJ.pPtr).value != thisJJ.subCond) {
//               mObj.mElements.at(thisJJ.pPtr).value = thisJJ.subCond;
//               needsLU = true;
//             }
//           }
//           if (thisJJ.nPtr != -1) {
//             if (mObj.mElements.at(thisJJ.nPtr).value != -thisJJ.subCond) {
//               mObj.mElements.at(thisJJ.nPtr).value = -thisJJ.subCond;
//               needsLU = true;
//             }
//           }
...
//             thisJJ.iT = thisJJ.vG * ((1 / thisJJ.r0) - thisJJ.gLarge);
//           if (thisJJ.pPtr != -1) {
//             if (mObj.mElements.at(thisJJ.pPtr).value != thisJJ.transCond) {
//               mObj.mElements.at(thisJJ.pPtr).value = thisJJ.transCond;
//               needsLU = true;
//             }
//           }
//           if (thisJJ.nPtr != -1) {
//             if (mObj.mElements.at(thisJJ.nPtr).value != -thisJJ.transCond) {
//               mObj.mElements.at(thisJJ.nPtr).value = -thisJJ.transCond;
//               needsLU = true;
//             }
//           }
//         } else {
...
//               - ((1 / thisJJ.rN) * thisJJ.upperB));
//           if (thisJJ.pPtr != -1) {
//             if (mObj.mElements.at(thisJJ.pPtr).value != thisJJ.normalCond) {
//               mObj.mElements.at(thisJJ.pPtr).value = thisJJ.normalCond;
//               needsLU = true;
//             }
//           }
//           if (thisJJ.nPtr != -1) {
//             if (mObj.mElements.at(thisJJ.nPtr).value != -thisJJ.normalCond) {
//               mObj.mElements.at(thisJJ.nPtr).value = -thisJJ.normalCond;
//               needsLU = true;
//             }
//           }
//         }
...
//       thisJJ.iS = -((M_PI * thisJJ.Del) / (2 * EV * thisJJ.rNCalc)) 
//         * (sin(thisJJ.phi0) / sqrt(1 - thisJJ.D * (sin(thisJJ.phi0 / 2) 
//         * sin(thisJJ.phi0 / 2)))) * tanh((thisJJ.Del) / (2 * BOLTZMANN * thisJJ.T) 
//         * sqrt(1 - thisJJ.D * (sin(thisJJ.phi0 / 2) * sin(thisJJ.phi0 / 2)))) 
