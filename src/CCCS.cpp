...
CCCS CCCS::create_CCCS(const std::pair<std::string, std::string> &s,
...
void CCCS::set_label(const std::string &s, 
                      std::unordered_set<std::string> &lm) {
  if(lm.count(s) != 0) {
...
void CCCS::set_nonZeros_and_columnIndex(const std::pair<std::string, std::string> &n1, 
...
void CCCS::set_indices(const std::pair<std::string, std::string> &n1, 
                        const std::pair<std::string, std::string> &n2, 
                        const std::unordered_map<std::string, int> &nm, 
                        std::vector<std::vector<std::pair<double, int>>> &nc, 
