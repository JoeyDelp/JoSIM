...
CCCS::CCCS(const std::pair<tokens_t, string_o>& s,
...
void CCCS::set_node_indices(const tokens_t& t, const nodemap& nm, nodeconnections& nc) {
    ...
    switch (nodeConfig2_) {
        case NodeConfig::POSGND:
            ...
            nc.at(nm.at(t.at(2)))
                    .emplace_back(std::make_pair((1 / netlistInfo.value_), indexInfo.currentIndex_.value()));
            break;
        case NodeConfig::GNDNEG:
