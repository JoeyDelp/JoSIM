...
void Errors::cli_errors(CLIErrors errorCode, string_o message) {
    ...
    switch (errorCode) {
        ...
        case CLIErrors::UNKNOWN_SWITCH:
            formattedMessage
                    += "Unknown option '" + message.value_or("") + "' specified. Please refer to the help menu.";
            warning_message(formattedMessage);
            break;
        case CLIErrors::UNKNOWN_OUTPUT_TYPE:
            formattedMessage += "Unknown output type " + message.value_or("") + " specified. CSV will be used instead.";
            warning_message(formattedMessage);
            break;
        ...
        case CLIErrors::NO_SOLVER:
            formattedMessage += "No solver was specified. Reverting to default (0 - KLU).\n";
            formattedMessage +=
          "Please refer to the help menu (-h) or manual for further "
          "information.";
            warning_message(formattedMessage);
        ...
        case CLIErrors::INVALID_MINIMAL:
            formattedMessage += "Invalid minimal output specified. 0 - Off, 1 - On.\n";
            formattedMessage += "Usage: josim [options] input_netlist\n\n";
            formattedMessage += "For further help use the -h switch";
            throw std::runtime_error(formattedMessage);
        default:
...
void Errors::input_errors(InputErrors errorCode, string_o message) {
    ...
    switch (errorCode) {
        case InputErrors::CANNOT_OPEN_FILE:
            formattedMessage += "Input file " + message.value_or("") + " cannot be found or opened.\n";
            formattedMessage += "Please ensure that the file exists and can be opened.\n\n";
            formattedMessage += "For further help use the -h switch";
            throw std::runtime_error(formattedMessage);
        case InputErrors::CYCLIC_INCLUDE:
            formattedMessage += "Attempting to include file " + message.value_or("") + ".\n";
        ...
        case InputErrors::SUBCKT_CONTROLS:
            formattedMessage += "Subcircuit " + message.value_or("") + " contains controls.\n";
        ...
        case InputErrors::DUPLICATE_SUBCIRCUIT:
            formattedMessage += "Subcircuit " + message.value_or("") + " already exist.\n";
        ...
        case InputErrors::UNKNOWN_SUBCKT:
            formattedMessage += "The subcircuit in the following line was not found:\n";
        ...
        case InputErrors::EMPTY_FILE:
            formattedMessage += "The file \"" + message.value_or("") + "\" contains no lines.\n";
        ...
        case InputErrors::UNKNOWN_CONTROL:
            formattedMessage += "The control \"" + message.value_or("") + "\" is not known.\n";
            formattedMessage += "Please consult the syntax guide for a list of available controls.";
            throw std::runtime_error(formattedMessage);
        default:
...
void Errors::invalid_component_errors(ComponentErrors errorCode, string_o message) {
    ...
    switch (errorCode) {
        ...
        case ComponentErrors::MISSING_JJMODEL:
            formattedMessage += "No junction model is specified for junction " + message.value_or("");
            throw std::runtime_error(formattedMessage);
        ...
        case ComponentErrors::MODEL_AREA_NOT_GIVEN:
            formattedMessage += "No area specified for junction " + message.value_or("") + "\n";
            formattedMessage += "Using default: AREA=1.0";
            warning_message(formattedMessage);
            break;
        case ComponentErrors::DUPLICATE_LABEL:
            formattedMessage += "Duplicate label " + message.value_or("") + " detected.\n";
            formattedMessage += "The program will now terminate. Please recheck the netlist.";
            throw std::runtime_error(formattedMessage);
        case ComponentErrors::INVALID_SUBCIRCUIT_NODES:
            formattedMessage += "The nodes of " + message.value_or("") + " do not match the subcicuit nodes.\n";
        ...
        case ComponentErrors::MISSING_SUBCIRCUIT_NAME:
            formattedMessage += "The subcircuit for " + message.value_or("") + " was not found in the file.\n";
        ...
        case ComponentErrors::MISSING_INDUCTOR:
            ...
            formattedMessage += "Please ensure that " + message.value_or("") + " exists.";
            throw std::runtime_error(formattedMessage);
        case ComponentErrors::UNKNOWN_DEVICE_TYPE:
            formattedMessage += "Unkown device type " + message.value_or("") + "\n";
            formattedMessage += "Please refer to the syntax guide for a list of device types.";
            throw std::runtime_error(formattedMessage);
        case ComponentErrors::SPECIAL_CHARS:
            formattedMessage += "Label " + message.value_or("") + " contains special characters.\n";
...
void Errors::control_errors(ControlErrors errorCode, string_o message) {
    ...
    switch (errorCode) {
        case ControlErrors::TRANS_ERROR:
            formattedMessage += "Invalid transient analysis specified. " + message.value_or("") + "\n";
            formattedMessage += "Substituting default parameters.\n";
            formattedMessage += "Defaults: TSTEP=1PS TSTOP=1000PS prstart=0PS PRSTEP=1PS";
            warning_message(formattedMessage);
            break;
        case ControlErrors::PRINT_TOO_MANY_ARGS:
            ...
            warning_message(formattedMessage);
            break;
        case ControlErrors::PRINT_ERROR: throw std::runtime_error(formattedMessage);
        case ControlErrors::PLOT_ERROR: throw std::runtime_error(formattedMessage);
        case ControlErrors::INV_CONTROL: throw std::runtime_error(formattedMessage);
        case ControlErrors::DC_ERROR: throw std::runtime_error(formattedMessage);
        case ControlErrors::AC_ERROR: throw std::runtime_error(formattedMessage);
        case ControlErrors::PHASE_ERROR: throw std::runtime_error(formattedMessage);
        ...
        case ControlErrors::VOLT_WHEN_PHASE:
            formattedMessage += "Request to store voltage for device " + message.value_or("") + "\n";
        ...
        case ControlErrors::NODEVOLT_WHEN_PHASE:
            formattedMessage += "Request to store nodal voltage for " + message.value_or("") + "\n";
            formattedMessage += "Phase mode simulation performed.\n";
            formattedMessage += "Storing nodal phase instead.";
            warning_message(formattedMessage);
            break;
        case ControlErrors::NODECURRENT:
            formattedMessage += "Request for current of " + message.value_or("") + " is invalid.\n";
            formattedMessage += "Cannot find device or cannot store current of a node.";
            warning_message(formattedMessage);
            break;
        case ControlErrors::UNKNOWN_NODE:
            formattedMessage += "Node " + message.value_or("") + " was not found in the circuit.\n";
            formattedMessage += "This request for store will be ignored.";
            warning_message(formattedMessage);
            break;
        case ControlErrors::NODEPHASE_WHEN_VOLT:
            formattedMessage += "Request to store nodal phase for " + message.value_or("") + "\n";
        ...
        default:
            formattedMessage += "Unknown control error: " + message.value_or("") + "\n";
            formattedMessage += "Please contact the developer.";
            throw std::runtime_error(formattedMessage);
    }
}
...
[[noreturn]] void Errors::matrix_errors(MatrixErrors errorCode, string_o message) {
    ...
    switch (errorCode) {
        case MatrixErrors::NON_SQUARE:
            formattedMessage += "Matrix is not square. Dimensions are " + message.value_or("") + "\n";
        ...
        case MatrixErrors::SANITY_ERROR:
            ...
            formattedMessage += "This is an internal error and the developer should be contacted.";
            throw std::runtime_error(formattedMessage);
        default:
            formattedMessage += "Unknown matrix error: " + message.value_or("") + "\n";
            formattedMessage += "Please contact the developer.";
            throw std::runtime_error(formattedMessage);
    }
}
...
[[noreturn]] void Errors::misc_errors(MiscErrors errorCode, string_o message) {
    ...
    switch (errorCode) {
        case MiscErrors::STOD_ERROR:
            formattedMessage += "Cannot convert string to double: " + message.value_or("");
            throw std::runtime_error(formattedMessage);
        default:
...
void Errors::function_errors(FunctionErrors errorCode, string_o message) {
    ...
    switch (errorCode) {
        ...
        case FunctionErrors::TOO_FEW_TIMESTEPS:
            formattedMessage += "Total timesteps specified do not match the values specified.\n";
            formattedMessage += message.value_or("") + " specified.\n";
            formattedMessage += "Please refer to the PWL definition:\n";
            formattedMessage += "PWL(0 0 T1 V1 T2 V2 ... Tn Vn)";
            throw std::runtime_error(formattedMessage);
        case FunctionErrors::TOO_FEW_VALUES:
            formattedMessage += "Total values specified do not match the timesteps specified.\n";
            formattedMessage += message.value_or("") + " specified.\n";
            formattedMessage += "Please refer to the PWL definition:\n";
            formattedMessage += "PWL(0 0 T1 V1 T2 V2 ... Tn Vn)";
            throw std::runtime_error(formattedMessage);
        ...
        case FunctionErrors::PULSE_TOO_FEW_ARGUMENTS:
            formattedMessage += "Total arguments specified do not match the required for PULSE.\n";
            formattedMessage += message.value_or("") + " specified.\n";
            formattedMessage += "Please refer to the PULSE definition:\n";
            formattedMessage += "PULSE(0 V2 TD TR TF PW PER)";
            throw std::runtime_error(formattedMessage);
        ...
        case FunctionErrors::SIN_TOO_FEW_ARGUMENTS:
            formattedMessage += "Total arguments specified do not match the required for SIN.\n";
            formattedMessage += message.value_or("") + " specified.\n";
        ...
        case FunctionErrors::CUS_TOO_FEW_ARGUMENTS:
            formattedMessage += "Total arguments specified do not match the required for CUS.\n";
            formattedMessage += message.value_or("") + " specified.\n";
        ...
        case FunctionErrors::NOISE_TOO_FEW_ARGUMENTS:
            formattedMessage += "Total arguments specified do not match the required for NOISE.\n";
            formattedMessage += message.value_or("") + " specified.\n";
        ...
        case FunctionErrors::EXP_TOO_FEW_ARGUMENTS:
            ...
            formattedMessage += message.value_or("") + " specified.\n";
            formattedMessage += "Please refer to the NOISE definition:\n";
            formattedMessage += "EXP(V1 V2 TD1[0.0] TAU1[TSTEP] TD2[TD1+TSTEP] TAU2[TSTEP])";
            throw std::runtime_error(formattedMessage);
        default:
            formattedMessage += "Unknown function error: " + message.value_or("") + "\n";
            formattedMessage += "Please contact the developer.";
            throw std::runtime_error(formattedMessage);
    }
}

[[noreturn]] void Errors::simulation_errors(SimulationErrors errorCode, string_o message) {
    std::string formattedMessage = "Simulation\n";
    switch (errorCode) {
        case SimulationErrors::JJCAP_NOT_FOUND:
            formattedMessage += "Capacitance for " + message.value_or("") + " could not be found.\n";
        ...
        case SimulationErrors::JJICRIT_NOT_FOUND:
            formattedMessage += "Critical current value for " + message.value_or("") + " could not be found.\n";
            formattedMessage += "This is a bug and the developer should be contacted.\n";
            formattedMessage += "The program will abort.";
            throw std::runtime_error(formattedMessage);
        case SimulationErrors::JJPHASE_NODE_NOT_FOUND:
            formattedMessage += "Junction phase node not found for " + message.value_or("") + ".\n";
            formattedMessage += "This is a bug and the developer should be contacted.\n";
            formattedMessage += "The program will abort.";
            throw std::runtime_error(formattedMessage);
        case SimulationErrors::INDUCTOR_CURRENT_NOT_FOUND:
            formattedMessage += "Inductor current not defined for " + message.value_or("") + ".\n";
        ...
        case SimulationErrors::PHASEGUESS_TOO_LARGE:
            formattedMessage += "Junction " + message.value_or("") + " has gone too far.\n";
            formattedMessage += "This is a result of integration error.\n";
            formattedMessage += "Please reduce the timestep and try again.";
            throw std::runtime_error(formattedMessage);
        default:
            formattedMessage += "Unknown simulation error: " + message.value_or("") + "\n";
            formattedMessage += "Please contact the developer.";
            throw std::runtime_error(formattedMessage);
    }
}
...
void Errors::parsing_errors(ParsingErrors errorCode, string_o message) {
    ...
    switch (errorCode) {
        case ParsingErrors::EXPRESSION_ARLEADY_DEFINED:
            formattedMessage += "Expression duplication: " + message.value_or("") + "\n";
        ...
        case ParsingErrors::MISMATCHED_PARENTHESIS:
            formattedMessage += "Mismatched parenthesis in expression: " + message.value_or("") + "\n";
        ...
        case ParsingErrors::INVALID_DECLARATION:
            formattedMessage += "Missing parameter declaration in: " + message.value_or("") + "\n";
            formattedMessage += "Please ensure that a valid .PARAM definition is declared.";
            throw std::runtime_error(formattedMessage);
        default:
            formattedMessage += "Unknown parsing error: " + message.value_or("") + "\n";
            formattedMessage += "Please contact the developer.";
            throw std::runtime_error(formattedMessage);
    }
}
...
[[noreturn]] void Errors::netlist_errors(NetlistErrors errorCode, string_o message) {
    ...
    switch (errorCode) {
        case NetlistErrors::NO_SUCH_NODE:
            formattedMessage += "Node \"" + message.value_or("") + "\" was not found in the netlist\n";
        ...
        case NetlistErrors::MISSING_IO:
            ...
            throw std::runtime_error(formattedMessage);
        default:
            formattedMessage += "Unknown netlist error: " + message.value_or("") + "\n";
            formattedMessage += "Please contact the developer.";
            throw std::runtime_error(formattedMessage);
    }
}
...
void Errors::output_errors(OutputErrors errorCode, string_o message) {
    ...
    switch (errorCode) {
        case OutputErrors::CANNOT_OPEN_FILE:
            ...
            formattedMessage += "Please ensure write permission for the file: " + message.value_or("");
            throw std::runtime_error(formattedMessage);
...
void Errors::verbosity_errors(VerbosityErrors errorCode, string_o message) {
    ...
    switch (errorCode) {
        case VerbosityErrors::NO_SUCH_LEVEL:
            formattedMessage += "No such verbosity level: " + message.value_or("") + "\n";
            formattedMessage += "Continuing with maximum verbosity.";
            warning_message(formattedMessage);
            break;
        case VerbosityErrors::INVALID_VERBOSITY_LEVEL:
            formattedMessage += "Invalid verbosity specified: " + message.value_or("") + "\n";
